    ...
    public class Context
    {
        ...
        public static List<int> GetSliceIndices(string slicesStr, int totalLength, string rawExpr, int startIndex)
        {
            ...
            {   // parse slice string to int start/end/step
                ...
                if (sliceArgs.Length > 3) { throw ArgCountError(I18n.Trl("slice"), "0-3", sliceArgs.Length, rawExpr); }
                ...
                try
                {
                    ...
                    {   // sliceArgs.Length = 3:  a:b:c, a:b:, a::c, :b:c, a::, :b:, ::c, ::
                        ...
                        if (step == 0) { throw InvalidValueError(I18n.Trl("slice"), "step", "0", rawExpr); }
                        if (startStr != "")
                ...
                catch { throw ParseTypeError(I18n.Trl("string"), slice, I18n.Trl("slice"), rawExpr); }
            ...
            string varName, string funcName, string totalExpression)
        {
            ...
            switch (type)
            {
                case "n": result = GetExtremumNum(strings, isMin); type = I18n.Trl("double"); break;
                case "h": result = GetExtremumHex(strings, isMin); type = I18n.Trl("hex"); break;
                case "s": result = GetExtremumStr(strings, isMin); type = I18n.Trl("string"); break;
            }
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    if (found == false)
                    {
                            ...
                            if (mx.Success)
                            {
                                ...
                                switch (idx)
                                {
                                    ...
                                    default:
                                        ...
                                        catch { throw InvalidValueError("_config", I18n.Trl("key"), idx, x); }
                                        break;
                                }
                                found = true;
                            }
                              ...
                              || x.StartsWith("?lvar:") || x.StartsWith("?l:"))
                        {
                            ...
                            else
                            {
                                ...
                                if (mx.Success)
                                {
                                    ...
                                    {
                                        throw ParseTypeError(I18n.Trl("index"), gindex, I18n.Trl("int"), x);
                                    }
                                    lock (store.List)
                                    {
                                        VariableList vl = GetListVariable(store, gname, false);
                              ...
                              || x.StartsWith("?tvar:") || x.StartsWith("?t:"))
                        {
                                ...
                                switch (gprop)
                                {
                                    ...
                                    case "vlookup": // .vlookup(targetStr, colIndex, rowslices = ":") => rowIndex
                                        ...
                                        lock (store.Table)
                                        {
                                            ...
                                            {
                                                throw ParseTypeError(I18n.Trl("string"), args[1], I18n.Trl("int"), x);
                                            }
                            ...
                            else
                            {
                                ...
                                if (mx.Success)
                                {
                                    ...
                                    {
                                        throw ParseTypeError(I18n.Trl("index"), gcol, I18n.Trl("int"), x);
                                    }
                                    if (!Int32.TryParse(grow, NSFloat, InvClt, out int yindex))
                                    {
                                        throw ParseTypeError(I18n.Trl("index"), grow, I18n.Trl("int"), x);
                                    }
                                    lock (store.Table)
                                    {
                                        VariableTable vt = GetTableVariable(store, gname, false);
                            ...
                            if (rxm.Success)
                            {
                                ...
                                switch (funcname)
                                {
                                    ...
                                    case "float2hex":
                                        {
                                            ...
                                            {
                                                throw ParseTypeError(I18n.Trl("string"), funcval, I18n.Trl("float"), x);
                                            }
                                    ...
                                    case "double2hex":
                                        {
                                            ...
                                            {
                                                throw ParseTypeError(I18n.Trl("string"), funcval, I18n.Trl("double"), x);
                                            }
                                    ...
                                    case "dec2hex8": // dec2hex8()
                                        {
                                            ...
                                            {
                                                throw ParseTypeError(I18n.Trl("string"), funcval, I18n.Trl("int"), x);
                                            }
                                    ...
                                    case "repeat": // repeat(times, joiner = "")
                                        {
                                            ...
                                            {
                                                throw ParseTypeError(I18n.Trl("times"), args[0], I18n.Trl("int"), x);
                                            }
                                            string joiner = GetArgument(args, 1, "");
                                            if (times == 0)
                                            {
                                    ...
                                    case "replace": // replace(oldStr, newStr = "", isLooped = false)
                                        {
                                            ...
                                            {
                                                throw ParseTypeError("isLooped", isLoopedStr, I18n.Trl("bool"), x);
                                            }
                                    ...
                                    case "substring": // substring(startindex, length) or substring(startindex)
                                        {
                                            ...
                                            {
                                                throw ParseTypeError(I18n.Trl("startindex"), args[0], I18n.Trl("int"), x);
                                            }
                                            if (startIndex < 0)
                                            {
                                            ...
                                            switch (argc)
                                            {
                                                ...
                                                case 2:
                                                    ...
                                                    {
                                                        throw ParseTypeError(I18n.Trl("length"), args[1], I18n.Trl("int"), x);
                                                    }
                                    ...
                                    case "pick": // pick(index, splitter = ",")
                                        {
                                            ...
                                            { throw ParseTypeError(I18n.Trl("index"), args[0], I18n.Trl("int"), x); }
                                    ...
                                    case "compare": // compare(stringtocompare) or compare(stringtocompare, ignorecase)
                                        ...
                                        {
                                            throw ParseTypeError("ignoreCase", ignoreCaseStr, I18n.Trl("bool"), x);
                                        }
                                    ...
                                    case "trimright":   // trimright() or trimright(charcode/char, charcode/char, ...)
                                        ...
                                        if (argc > 0)
                                        {
                                            foreach (string arg in args)
                                            {
                                                ...
                                                {
                                                    throw InvalidValueError(funcname, I18n.Trl("char") + "/" + I18n.Trl("charcode"), funcval, x);
                                                }
                                                else if (arg.Length > 1)
                                                {
                                                    if (!int.TryParse(arg, NSFloat, InvClt, out int charcode))
                                                    {
                                                        throw ParseTypeError(I18n.Trl("charcode"), arg, I18n.Trl("int"), x);
                                                    }
                        ...
                        {
                            val = RealPlugin.plug != null ? RealPlugin.plug.path : "";
                            found = true;
                        }
                        else if (x == "_pluginpath")
                        {
                            val = RealPlugin.plug != null ? RealPlugin.plug.pluginPath : "";
                            found = true;
                        }
        ...
        internal static Exception InfiniteClipboardError()
        {
